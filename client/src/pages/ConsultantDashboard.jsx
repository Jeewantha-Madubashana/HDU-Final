...
const ConsultantDashboard = () => {
  ...
  const fetchBeds = async () => {
    ...
    try {
      ...
      dispatch(setAppBarTitle(`Consultant Dashboard - Beds`));
    } catch (err) {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      console.error("[ConsultantDashboard] Error assigning bed:", error);
      throw error;
    } finally {
      dispatch(setLoading(false));
    }
    ...
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Welcome, {user?.fullName}. Manage patient bed assignments, monitor critical alerts, and oversee patient care.
        </Typography>
      </Box>
      ...
      {selectedTab === 0 && (
        <Card sx={{ p: 3, mb: 3 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            ...
            As a Consultant, you can admit patients, update vitals, and discharge patients.
          </Typography>
